...
public class SignupUseCaseFactory {
    ...
    private static ClearViewModel clearViewModel;

    /** Prevent instantiation. */
    private SignupUseCaseFactory() {}

    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, SignupUserDataAccessInterface signupUserDataAccessObject, ClearUserDataAccessInterface clearUserDataAccessObject) {
    ...
    private static ClearController createUserClearUseCase(ClearUserDataAccessInterface clearUserDataAccessInterface) {
